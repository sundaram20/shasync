    ...
    // 24 * 60 * 60 = 86400 seconds 
     $DateNoDays = abs(round($diff / 86400)); 
            ...
            <div class="form-group col-md-5">
             ...
             <select  class="form-control select2 itemName" onchange="getExecutiveName(this.value,\'\');" name="id_company" id="id_company" data-parsley-errors-container="#idcompanyError"  data-parsley-required>
