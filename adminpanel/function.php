...
//Sorting Order Number Height to Low
      ...
      foreach($subDataList as $list=> $DataList){
           if($DataList['roomnights']>0 || $DataList['lastYearroomnights']>0){
                 if($DataList['confimed_revenue']>0 || $DataList['lastYearconfimed_revenue']>0){
                        ...
                        $golyRowWiseRoomNights    = round((($DataList['roomnights']-$DataList['lastYearroomnights'])/$DataList['lastYearroomnights']) *100,2);
            ...
            $SumTeamTotalgolyRoomNights=round((($TotalTeamRoomNight-$TotalTeamRoomNightlastYear)/$TotalTeamRoomNightlastYear) *100,2);
    ...
    $SumTotalGolyRoomNights=round((($TotalRoomNight-$TotalRoomNightlastYear)/$TotalRoomNightlastYear) *100,2);
...
array_multisort($RoomNights, SORT_DESC, $RoomRevenue, SORT_ASC, $GroupArray);       
     ...
     foreach($GroupArray as $name => $GroupNameArray){    
                 ...
                 foreach($GroupArray as $name => $GroupNameArray){
                     if(strtoupper($name)!='UNIT'){
                     $GolyGroupRoomNights=round((($GroupNameArray['RoomNights']-$GroupNameArray['lastYearroomnights'])/$GroupNameArray['lastYearroomnights']) *100,2);
                     $GolyGroupRoomRevenue=round((($GroupNameArray['RoomRevenue']-$GroupNameArray['lastYearconfimed_revenue'])/$GroupNameArray['lastYearconfimed_revenue']) *100,2);
             ...
             //$SumTotalTeamWiselastYearArray= round($TotalTeamWiseConfimedRevenuelastYear/$TotalTeamWiseRoomNightlastYear);
              ...
              $SumTotalGolyTeamRoomNights=round((($TotalTeamWiseRoomNight-$TotalTeamWiseRoomNightlastYear)/$TotalTeamWiseRoomNightlastYear) *100,2);
              $SumTotalGolyTeamConfimedRevenue=round((($TotalTeamWiseConfimedRevenue-$TotalTeamWiseConfimedRevenuelastYear)/$TotalTeamWiseConfimedRevenuelastYear) *100,2);
