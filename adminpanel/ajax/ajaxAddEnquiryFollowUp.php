...
$availableData .=' <div class="form-group"><input type="text" class="form-control"  name="followup_description['.$OtherChargesuniqueCode.']" id="followup_description|'.$OtherChargesuniqueCode.'" value=""  placeholder="Internal Remarks" maxlength="150"></lable></div>';
