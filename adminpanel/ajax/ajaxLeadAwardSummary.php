...
if($_REQUEST['date_period']!=''){
	...
	$to=$financial_year[1];
	$sqlConn .= "  AND DATE(`eqd`.dated) BETWEEN '".date('Y-m-d',strtotime($from))."' AND '".date('Y-m-d',strtotime($to))."'";	
	
	}else{
		
		$sqlConn .= "  AND DATE(`eqd`.dated) BETWEEN '".date('Y-04-01')."' AND '".date('Y-m-d',strtotime($_REQUEST['per_report_date']))."'";
		$from=date('Y-04-01');
                       ...
                       <table id="accordion"  class="card table table-striped text-center" style=" border: 1px solid :#3C8DBC;">
                              ...
                              <thead>
                                    <tr style="color:white;">
                                       <th colspan="9" style="background-color:#548235;vertical-align: middle;font-size:18px;">Sales Lead Award Summary Period '.date('d-m-Y',strtotime($from)).' To '.date('d-m-Y',strtotime($to)).' </th>     
                                     </tr>
                                     <tr style="color:white;">
            ...
            <div class="row">
                   <div class="col-md-12">
                       <table id="accordion"  class="card table table-striped text-center" style=" border: 1px solid :#3C8DBC;">
                              ...
                              <thead>
                                    <tr style="color:white;">
                                       <th colspan="9" style="background-color:#548235;vertical-align: middle;font-size:18px;">Sales Lead  Summary  Period '.date('d-m-Y',strtotime($from)).' To '.date('d-m-Y',strtotime($to)).' </th>     
                                     </tr>
                                     <tr style="color:white;">
                                        <th rowspan="2" style="border:1px solid #000;background-color:#fff;color:#000;vertical-align: middle;">S NO</th>
