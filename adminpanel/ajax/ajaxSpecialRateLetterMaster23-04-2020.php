...
if(num_rows($resInclusion)==0){
 ...
 $availableData .= '<div class="box box-primary  table-responsive no-padding" style="border: 1px solid #00a65a;">';
                  ...
                  <input type="text" class="form-control " id="special_rate_name" name="special_rate_name['.$SpecialIncrementId.']" value="'.$special_rate_name.'" data-parsley-required data-parsley-errors-container="#special_rate_nameError"  >
