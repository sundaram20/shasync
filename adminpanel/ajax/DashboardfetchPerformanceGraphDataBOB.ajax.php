...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND  `fs_order_detail`.`dated` BETWEEN '".date('Y-m-d',strtotime($dateCalcultion['From_CY_Date']))."' And '".date('Y-m-d',strtotime($dateCalcultion['To_CY_Date']))."' ".$allUser." ".$condBOB." ";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND DATE(`fs_order_detail`.dated ) BETWEEN '".date('Y-m-d',strtotime('-1 years',strtotime($from_book)))."' AND '".date('Y-m-d',strtotime($dateCalcultion['To_LY_Finacial_Year']))."' ".$allUser." ".$condBOB." ";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND  `fs_order_detail`.`dated` BETWEEN '".date('Y-m-d',strtotime($from_book))."' And '".date('Y-m-d',strtotime($toDate))."' ".$allUser." ".$condBOB."  group by `fs_users`.id";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND MONTH(`fs_order_detail`.dated) = '".$monthNUmers."' AND YEAR(`fs_order_detail`.dated) = '".$startYr."' ".$allUser." ".$condBOB."  ";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND MONTH(`fs_order_detail`.dated) = '".$monthNUmers."' AND YEAR(`fs_order_detail`.dated) = '".$PrevstartYr."' ".$allUser." ".$condBOB."  
";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND  `fs_order_detail`.`dated` BETWEEN '".date('Y-m-d',strtotime($dateCalcultion['From_CY_Date']))."' And '".date('Y-m-d',strtotime($dateCalcultion['To_CY_Date']))."' ".$allUser." ".$condBOB."   GROUP BY `".TBL_ORDERS."`.segment_id";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND  `fs_order_detail`.`dated` BETWEEN '".date('Y-m-d',strtotime('-1 years',strtotime($from_book)))."' AND '".date('Y-m-d',strtotime($dateCalcultion['To_LY_Finacial_Year']))."' ".$allUser." ".$condBOB."   GROUP BY `".TBL_ORDERS."`.segment_id";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND  `fs_order_detail`.`dated` BETWEEN '".date('Y-m-d',strtotime($dateCalcultion['From_CY_Date']))."' And '".date('Y-m-d',strtotime($dateCalcultion['To_CY_Date']))."' ".$allUser." ".$condBOB."   GROUP BY `".TBL_COMPANY."`.id_default_group";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND DATE(`fs_order_detail`.dated ) BETWEEN '".date('Y-m-d',strtotime('-1 years',strtotime($from_book)))."' AND '".date('Y-m-d',strtotime($dateCalcultion['To_LY_Finacial_Year']))."' ".$allUser." ".$condBOB."   GROUP BY `".TBL_COMPANY."`.id_default_group";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND  `fs_order_detail`.`dated` BETWEEN '".date('Y-m-d',strtotime($dateCalcultion['From_CY_Date']))."' And '".date('Y-m-d',strtotime($dateCalcultion['To_CY_Date']))."' ".$allUser." ".$condBOB."   GROUP BY `".TBL_ORDERS."`.id_booking_source";
...
where `fs_orders`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND DATE(`fs_order_detail`.dated ) BETWEEN '".date('Y-m-d',strtotime('-1 years',strtotime($from_book)))."' AND '".date('Y-m-d',strtotime($dateCalcultion['To_LY_Finacial_Year']))."' ".$allUser." ".$condBOB."   GROUP BY  `".TBL_ORDERS."`.id_booking_source";
