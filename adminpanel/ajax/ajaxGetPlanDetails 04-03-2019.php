...
$double_pax_price = ($rowRoom->double_pax_price==0?'Rate on request':$rowRoom->double_pax_price);
$single_pax_price = ($rowRoom->single_pax_price==0?'Rate on request':$rowRoom->double_pax_price);
