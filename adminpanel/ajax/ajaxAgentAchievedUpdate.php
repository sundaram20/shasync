		...
		if(($_POST['Save'] == 'Add') && empty($_REQUEST['id'])){//add
			...
			echo '<p class="help-block">User Budget has been updated sucessfully.</p>';
				...
				foreach($data_id as $data =>$value){
					...
					$EditId	=selectColumn(TBL_AGENT_ACHIEVED,'id',"WHERE `id_company`='".addslashes($value)."' AND  seasonId = '".addslashes($_POST['seasonId'])."' ");
			...
			echo '<p class="help-block">Achievement has been updated sucessfully.</p>';
		}//end of else if
