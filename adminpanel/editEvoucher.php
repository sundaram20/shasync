        ...
        <div class="col-md-12"> 
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title"><?php echo $_REQUEST['eId']==''?'Add':'Edit'?> Evoucher : <?php echo $_REQUEST['eId']=='' ? 'Add':$row->promo_code;?> </h3>
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input disabled type="text" class="form-control" placeholder="Enter Voucher Value" id="vaoucher_value" name="vaoucher_value" value="<?php if($_POST) echo $_POST['vaoucher_value'];else echo stripslashes($row->vaoucher_value);?>" data-parsley-required >
                    ...
                    <input disabled type="text" class="form-control" placeholder="Enter Food & Beverage Value" id="food_value" name="food_value" value="<?php if($_POST) echo $_POST['food_value'];else echo stripslashes($row->food_value);?>" data-parsley-required >

                    <?php echo $err_pincode;?> </div>

                    <div class="form-group col-sm-3">

                    <label for="Employee_title">S.no<font color="#FF0000">*</font></label>

                    <input  type="text" class="form-control" placeholder="Enter Serial Number" id="serial_no" name="serial_no" value="<?php if($_POST) echo $_POST['serial_no'];else echo stripslashes($row->serial_no);?>" data-parsley-required >

                    <?php echo $err_pincode;?> </div>

                    <div class="form-group col-sm-3">

                    <label for="Employee_title">Employee id<font color="#FF0000">*</font></label>

                    <input  type="text" class="form-control" placeholder="Enter Employee Id" id="emp_id" name="emp_id" value="<?php if($_POST) echo $_POST['emp_id'];else echo stripslashes($row->emp_id);?>" data-parsley-required >
                    ...
                    <label for="Employee_title">Title<font color="#FF0000">*</font></label>

                    <input  type="text" class="form-control" placeholder="Enter Title" id="emp_title" name="employee_title" value="<?php if($_POST) echo $_POST['emp_title'];else echo stripslashes($row->emp_title);?>" data-parsley-required >
                    ...
                    <label for="Employee">Employee Name<font color="#FF0000">*</font></label>

                    <input  type="text" class="form-control" placeholder="Enter Food & Beverage Value" id="employee_name" name="employee_name" value="<?php if($_POST) echo $_POST['employee_name'];else echo stripslashes($row->employee_name);?>" data-parsley-required >
                 ...
                 <!--<div class="form-group col-sm-4">
                      ...
                      <?php $bookDropDown = '<select class="form-control" name="promo_code_edit" multiple="multiple" id="promo_code_edit" onclick="reportSelection(this.value,this.id);" required="required">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input disabled type="text" class="form-control pickerdate" placeholder="Enter Date valid from" id="date_valid_from" name="date_valid_from" value="<?php if($_POST) echo $_POST['date_valid_from'];elseif($row->date_valid_from) echo stripslashes(date('d-m-Y',strtotime($row->date_valid_from))); else echo date('d-m-Y'); ?>"  data-parsley-required>
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input disabled type="text" class="form-control pickerdate" placeholder="Enter end date" id="date_valid_to" name="date_valid_to" value="<?php if($_POST) echo $_POST['date_valid_to'];elseif($row->date_valid_to) echo stripslashes(date('d-m-Y',strtotime($row->date_valid_to))); else echo date('d-m-Y'); ?>"  data-parsley-required>
  ...
  status = document.getElementById('status').value;
   ...
   $('.loading').show();		  
		  ...
		  $.ajax({
			   ...
			   url: 'ajax/ajaxSavePromocode.php',

			    data: 'id_company='+id_company+'&no_of_coupons='+no_of_coupons+'&length='+length+'&date_valid_to='+date_valid_to+'&date_valid_from='+date_valid_from+'&vaoucher_value='+vaoucher_value+'&scheme_type='+scheme_type+'&numbers='+numbers+'&emp_id='+emp_id+'&serial_no='+serial_no+'&employee_name='+employee_name+'&emp_title='+emp_title+'&status='+status+'&eId='+eId+'&promo_code_edit='+promo_code_edit+'&food_value='+food_value, 
  ...
  <script type="text/javascript">
   /* $('#serial_no').change(function(){
      ...
      $.ajax({
         ...
         url: 'ajax/ajaxSerialEvoChk.php',

          data: 'ser_id='+ser_no+'cng_id='+cng_id, 
