  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="padding: 0px 15px;">
       ...
       <!--start of lead summary award1-->
        <div id="blk-leadaward" class=""  style="display:block!important;">
            <div class="row">
                   <div class="col-md-12">
                       <table id="accordion"  class="card table table-striped text-center" style=" border: 1px solid :#3C8DBC;">
                              ...
                              <thead>
                                    ...
                                    <tr style="color:white;cursor:pointer;" class="card-header"  data-toggle="collapse" data-target="#collapse2" aria-expanded="true" aria-acontrols="collapse2" >
                                       <td  style="border:1px solid #000;background-color:#FFF;color:#000;">1</td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;font-weight:600;">Adarsh  <div style="font-weight:500;">The fern Seaside luxurious Tent Resort, Daman</div></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;"></td>
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">26</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">10</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">7</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">9</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;font-weight:700;">60</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;font-weight:700;">10</td>
                                    </tr>
                                 </tbody>    

                                    <tbody id="collapse2" class="collapse" data-parent="#accordion" style="border-top:none!important;">
                                     <tr style="color:white;">
                                       <td  style="border:1px solid #000;background-color:#FFF;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;;color:#000;">The Fern, Jaipur</td>
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;">12</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">3</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">4</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">5</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;">27</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;">4</td>
                                     </tr> 
                                   ...
                                   <tr style="color:white;">
                                       <td  style="border:1px solid #000;background-color:#FFF;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;">The Wall Street Hotel, Jaipur</td>
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;">14</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">7</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">3</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">4</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;">33</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;">6</td>
                                    </tr>
                                  </tbody> 

                                  <tbody style="border-top:none!important;">
                                    <tr style="color:white;cursor:pointer;"  class="card-header"  data-toggle="collapse" data-target="#collapse1"  aria-expanded="true" aria-acontrols="collapse1">
                                       <td  style="border:1px solid #000;background-color:#FFF;color:#000;">2</td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;font-weight:600;">Bhupendra <div  style="font-weight:500;">The fern Residency Jaipur </div></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;"></td>
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">13</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">5</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">6</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">2</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;font-weight:700;">50</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;font-weight:700;">5</td>
                                    </tr> 
                                  </tbody>  


                                   <tbody id="collapse1" class="collapse" data-parent="#accordion" style="border-top:none!important;">
                                    
                                    <tr style="color:white;" >
                                       <td  style="border:1px solid #000;background-color:#FFF;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;;color:#000;">The Fern Residency, Jaipur</td>
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;">6</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">3</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">2</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">1</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;">30</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;">3</td>
                                    </tr> 
                                   ...
                                   <tr style="color:white;">
                                       ...
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;">7</td>
                                        ...
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">4</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">1</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;">20</td>
                                        <td style="border:1px solid #000;background-color:#E2EFDA;color:#000;">2</td>
                                    </tr> 
      ...
      <!--start of lead summary award2-->
        <div id="blk-leadaward2" class=""  style="display:block!important;">
            <div class="row">
                   <div class="col-md-12">
                       <table id="accordion"  class="card table table-striped text-center" style=" border: 1px solid :#3C8DBC;">
                              ...
                              <thead>
                                    ...
                                    <tbody style="border-top:none!important;">
                                    <tr style="color:white;cursor:pointer;" class="card-header"  data-toggle="collapse" data-target="#collapse4" aria-expanded="true" aria-acontrols="collapse4" >
                                       <td  style="border:1px solid #000;background-color:#FFF;color:#000;">1</td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;;color:#000;font-weight:600;">The Wall Street Hotel, Jaipur</td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;;color:#000;"></td>
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">26</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">10</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">7</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">9</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;font-weight:700;">60</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;font-weight:700;">10</td>
                                    </tr>
                                 </tbody>    

                                    <tbody id="collapse4" class="collapse" data-parent="#accordion" style="border-top:none!important;">
                                     <tr style="color:white;">
                                       <td  style="border:1px solid #000;background-color:#FFF;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;font-weight:600;">Bhupendra <div  style="font-weight:500;">The fern Residency Jaipur </div></td>
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;">12</td>
                                        ...
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">4</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">5</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;">27</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;">4</td>
                                     </tr> 
                                   ...
                                   <tr style="color:white;">
                                       ...
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;">14</td>
                                        ...
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">3</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">4</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;">33</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;">6</td>
                                    </tr>
                                  </tbody> 


                                    <tbody style="border-top:none!important;">
                                    <tr style="color:white;cursor:pointer;"  class="card-header"  data-toggle="collapse" data-target="#collapse3"  aria-expanded="true" aria-acontrols="collapse3">
                                       <td  style="border:1px solid #000;background-color:#FFF;color:#000;">2</td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;font-weight:600;">The Fern Residency, Jaipur</td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;"></td>
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">13</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">5</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">6</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;font-weight:700;">2</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;font-weight:700;">50</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;font-weight:700;">5</td>
                                    </tr> 
                                  </tbody>  


                                   <tbody id="collapse3" class="collapse" data-parent="#accordion" style="border-top:none!important;">
                                    
                                    <tr style="color:white;" >
                                       <td  style="border:1px solid #000;background-color:#FFF;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;font-weight:600;">Bhupendra <div style="font-weight:500;"> The fern Seaside luxurious Tent Resort, Daman</div></td>
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;">6</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">3</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">2</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">1</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;">30</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;">3</td>
                                    </tr> 
                                   ...
                                   <tr style="color:white;">
                                       <td  style="border:1px solid #000;background-color:#FFF;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;"></td>
                                        <td style="border:1px solid #000;background-color:#FCE4D6;color:#000;font-weight:600;">Adarsh <div style="font-weight:500;">The Fern Residency, Jaipur</div></td>
                                       <td style="border:1px solid #000;background:#FFF2CC;color:#000;">7</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">2</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">4</td>
                                        <td style="border:1px solid #000;background:#FFF2CC;color:#000;">1</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;">20</td>
                                        <td style="border:1px solid #000;background-color:#C6E0B4;color:#000;">2</td>
                                    </tr> 
