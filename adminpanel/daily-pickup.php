...
<div class="content-wrapper">
	...
	<div class="box box-default" style="margin-bottom : 0!important;">
	 ...
	 <div class="form-group has-error " align="center" style="display : none;">
        ...
        <div class="box-header with-border" style="padding-top : 5px!important;">
          <?php /*?><h3 class="box-title">Search <small>Total Records: (<?=$numRows;?>) &nbsp;</small> </h3><?php */?>
		  <div class="btn-group  pull-right">
                  <a type="button" class="btn btn-success" href="edit-daily-pickup.php">Add Pickup</a>
   ...
   <div class="col-md-3">
		                          <div class="form-group">
		            				...
		            				<input type="date" class="form-control select2" name="id_phone" value=""/>
		                          </div>
		                          <!-- /.form-group -->
		                        </div>   
          ...
          <div class="form-group col-md-3 ">
            ...
            <!--Area Executive-->
              ...
              <div class="form-group">
                <label>Company Name</label>				
				<select class="form-control select2" name="id_default_group">
											    <option value="">Select Company Name</option></select>
              </div>
			 ...
			 <!--Search by Company Mobile-->
		            		  <div class="col-md-3">
		                          <div class="form-group">
		                            <label>Bill No.</label>				
		            				<input class="form-control select2" name="id_phone"/>
		                          </div>
		                          <!-- /.form-group -->
		                        </div>   
			  ...
			  <div class="col-md-3">
		                          <div class="form-group">
		            				...
		            				<input type="date" class="form-control " name="id_phone" value=""/>
		                          </div>
		                          <!-- /.form-group -->
		                        </div>   
			 ...
			 <div class="col-md-3 ">
				 <div class="form-group">
				  <label style="width : 100%!important; visibility : hidden!important;">Bill Date</label>		
        <input name="Apply" type="submit" class="btn btn-primary" value="Apply"  style="width :40%!important;"/>
              ...
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>1</td>
					...
					<td>1</td>
					<td>1</td>
					<td style=""><img src="images/delete.gif" style="cursor:pointer; " title="Delete" name="<?php echo $row->name; ?>" id="<?php echo $row->id_company;?>" onClick="deleteMe(this.id,this.name);"/></td>
