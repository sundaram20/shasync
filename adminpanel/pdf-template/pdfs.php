...
$previous = $current;
 ...
 if ($resultHotelDetail->excel_display_weekday  =='1'){		 
					 $SingleAndWeekday	='<th width="110px;"><b>WEEKDAYS (MON-THU)</b></th>
											<th width="110px;"><b>WEEKENDS (FRI-SUN)</b></th>';
 }elseif ($resultHotelDetail->excel_display_weekday  =='2'){		 
					 $SingleAndWeekday	='<th width="110px;"><b>WEEKDAYS (SUN-THU)</b></th>
											<th width="110px;"><b>WEEKENDS (FRI-SAT)</b></th>';
		 }else{
...
if ($resultHotelDetail->excel_display_weekday  =='1' || $resultHotelDetail->excel_display_weekday  =='2'){
...
// $Filename	=str_replace('-','/',$Companyname);//.'-'.$Seassionname;
//$Filename='rateletter';
