            ...
            <div class="box-header with-border">
              <div class="nav-tabs-custom col-md-12"> 
                        ...
                        <div class="form-group col-md-9">
                            ...
                            <a title="Add Other Entry" class="btn btn-success" href="otherEntry.php" style="color:#fff;font-weight:bold;">&nbsp;ADD TODAY</a>
                            <a title="Add Visite" class="btn btn-success" href="addreport.php" style="color:#fff;font-weight:bold;">&nbsp;ADD VISIT</a>
                            <a href="editEnquiry.php" class="btn btn-success"  style="color:#fff;font-weight:bold;">
                                                   &nbsp; ADD LEAD
                                                  </a>
                            <a title="Add Quote" class="btn btn-success" href="editQuote.php" style="color:#fff;font-weight:bold;">&nbsp;ADD QUOTE</a>
                            
                            <a title="Add Notification" class="btn btn-success" href="addNotification.php" style="color:#fff;font-weight:bold;">&nbsp;ADD NOTIFICATION</a>
                        </div>         
              </div>
             ...
             <!-- Approval List -->
                ...
                <span id="displayNotifyTxt" style="cursor: pointer;" title="click to expand"></span>
              

              <div id="approvalNotify" style="display:none;color:green;font-size:1.5rem;" class="text-center">
                <span id="approvalNotifyTxt" style="cursor: pointer;" title="click to expand"></span>
              ...
              <div id="displayNotify" style="display:none;color:green;font-size:1.5rem;" class="text-center">
                <div id="tableNotifyData" style="display:none;margin:0px auto;height: 200px; overflow-y: scroll;">
...
function ajaxloadpending(){
	...
	var selected1 = 'selected=selected';
	 ...
	 $.ajax({
       ...
       if(result !=""){
        $('#approvalNotify').show();
        $('#approvalNotifyTxt').html('<button class="btn btn-success"><b>Check Pending Approvals '+'['+JSON.parse(result)[1]+'] !</b></button>');
...
<div class="form-group">
           ...
           <?php   $availableData .='<div class="form-group"><label style="float:left;">Assign To</label>';
                 ...
                 $availableData .= '<select class="form-control select2" name="assign_user_id" id="assign_user_id">
				  ...
				  $resUserLevel = selectSql(TBL_USERS," WHERE `status` = '1' AND  `id_shop` = '".addslashes($_SESSION['shop'])."' ".$teamMembers." ",' ORDER BY `name`');
											  if($db->num_rows2($resUserLevel)){
											  	while($resultUserLevel = $db->fetch_object2($resUserLevel)){
													if($_SESSION['userId'] == $resultUserLevel->id){
														$selected = 'selected="selected"';
