              ...
              <table id="example2" class="table table-bordered table-striped">
				...
				if($total > 0){$counter = 1;
				  while($row = $db->fetch_object()){
					 ...
					 $sqlQuery = "SELECT sum(sales_revenue) as sales_revenueTotal FROM `daily_pickup_details` WHERE id_daily_pickup='".$row->id."'  group by id_daily_pickup";
                  ...
                  <tr>
					...
					<td><?php 
					 ...
					 echo  $PendingStatus;?></td>
					  <td><?php echo  $row->count_payment_receipt;?></td>
					  <td><?php echo  $row->count_payment_reminder;?></td>
					  <td><?php echo  $row->count_renewal_reminder;?></td>
					  <td><?php echo  $row->count_thank_you;?></td>
