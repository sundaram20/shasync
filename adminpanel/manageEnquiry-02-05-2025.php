...
if($_SESSION['userLevel']!='1'){
	//echo $_SESSION['userLevel'].'==='.$display_lead_summary!='1' && !isset($_REQUEST['drilled_team'];
...
if($_REQUEST['id_company'] !=""){
  ...
  $sql.=" AND A.id_company=".$_REQUEST['id_company']." ";
...
cellColor('A7:O7','75923c');
	...
	$objPHPExcel->getActiveSheet()->getStyle('A7:O7')->applyFromArray($styleArray_1);

	 $objPHPExcel->getActiveSheet()->getStyle('A7:O7')->getAlignment()->applyFromArray(
...
$objPHPExcel->getActiveSheet()->getStyle('A6:O6')->applyFromArray($styleThinBlackBorderOutline);

$objPHPExcel->getActiveSheet()->getStyle('A7:O7')->applyFromArray($styleThinBlackBorderOutline);
