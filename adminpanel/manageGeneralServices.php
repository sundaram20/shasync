...
if($_REQUEST['action'] == 'change'){
	...
	$delSql = "DELETE FROM `".TBL_GENERAL_SERVICES."` WHERE `id` = '".$_REQUEST['delId']."'";
	$sqlDelUserLevel = selectRow(TBL_GENERAL_SERVICES," WHERE `id` = '".$_REQUEST['delId']."'");
