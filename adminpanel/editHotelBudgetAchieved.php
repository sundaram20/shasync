...
?>
          ...
          <div class="box-header with-border">
            ...
            <h3 class="box-title"><?php echo $_REQUEST['id']==''?'Add':'Edit'?> Hotel Wise Monthly Achieved <?php echo $row->rate_name.'-'.$row->sub_code;  ?> </h3>
          ...
          <form name="form1" id="rateUpdate"  method="post" enctype="multipart/form-data" role="form" data-parsley-validate autocomplete="off">
            ...
            <div class="box-footer ">
              ...
              <input type='button' value='Close' class="btn btn-default" onclick='location.replace("manageHotelBudgetAchieved.php?page=<?php echo $_GET['page']; ?>"); '>
