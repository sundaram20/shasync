          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <?php //if($_REQUEST['eId']==''){?>
                <a class="pull-left btn btn-success btn-xs" onclick="addEqyFollowUp(0);" <?php echo $disabled ?> type="button" id="enqFollowUp" >1 Assign Lead </a>
                <?php //}else{?>
                <a class="pull-left btn btn-success btn-xs" <?php echo $disabled ?> type="button" > 2 Assign Lead </a>
                <?php //}?>
              </div>
