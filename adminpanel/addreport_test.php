...
if(!empty($_REQUEST['eId']) && $_REQUEST['action']=='edit'){
	?>
<input type="text" readonly  class="form-control pickerdate_addreport" placeholder="Enter end date" id="report_date" name="report_date" value="<?php echo $report_date;?>"  data-parsley-required>
<?php
...
if($dsrNoDays==0){
?>
<input type="text" readonly class="form-control pickerdate" placeholder="Enter end date" id="report_date" name="report_date" value="<?php echo $report_date;?>"  data-parsley-required>
<?php }else{ 
?>
                  <input type="text" readonly class="form-control pickerdate_addreport" placeholder="Enter end date" id="report_date" name="report_date" value="<?php echo $report_date;?>"  data-parsley-required>
<?php } 
...
<label for="name">Company Name<font color="#FF0000">*</font></label>
 <div class="input-group" >
  <select class="itemName form-control" style="width:500px" name="id_company" id="id_company" onChange="getExecutiveName(this.value,''); areaExecutive(this.value);"> </select>
</div>
...
<?php } ?>	
 ...
 function searchCompanylist(term){
	//alert(term);
 ...
 $( "#autocomplete" ).autocomplete({
  ...
  select: function (event, ui) {
   ...
   $('#id_company').val(ui.item.value); // save selected id to input
   areaExecutive();
   getExecutiveName(ui.item.value,'');
   return false;
  }
 });
