              ...
              <div class="content">
                  ...
                  <section class="account-section">
                      ...
                      <div id='validateform' class="text-center">
                         <input type="hidden" name="id_invoice_request" id="id_invoice_request" value="" />
                         <button class="btn btn-primary valinv" onclick="listinvoice();">Validate </button>
                          <button class="btn btn-success valsubmit"  style="display:none;" id="importInvoice" onclick="InsertInvoice();">Submit</button>
                     </div>
                     <br/>
                     <!--end of validate-->
                        <div class="box">
                              <div class="">
                                <h4 class="mb-0 text-center"><b>Invoice List</b></h4>
                              </div>
...
function InsertInvoice(){
	...
	$.ajax({
			   ...
			   type: "POST",
			   url: 'ajax/ajaxInsertInvoice.php',
