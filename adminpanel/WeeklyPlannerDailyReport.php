...
include_once("includes/reportFunctionsWeeklyPlannerDailyReport.php");
...
if($_REQUEST['Download'] == 'Download'){
	...
	if(!isset($cron)){
		WeeklyPlannerDailyReport($_SESSION['shop'],$_REQUEST['usernameid'],$_REQUEST['report_date'],$_REQUEST['teamId'],$_REQUEST['companyId'],$cron,$db,$connNew,$objPHPExcel,$fileName);
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <h1> Weekly Planner Manager<small>Weekly Planner Report</small> </h1>

    <ol class="breadcrumb">

      <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>

      <li class="active">Weekly Planner Report</li>
