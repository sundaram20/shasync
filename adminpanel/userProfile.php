      ...
      <?php 
        ...
        <?php //echo $err_display_order;?>
                ...
                <div class="form-group col-sm-6">
                  ...
                  <input type="password" class="form-control" placeholder="Enter Smtp Password"  <?php echo $required?> id="smtp_password" name="smtp_password" value="<?php if($_POST) echo $_POST['smtp_password'];else echo stripslashes($rowUserDetail->smtp_password);?>">
        ...
        <?php //echo $err_display_order;?>
				...
				<div class="form-group">
                  <label for="last_modified_by">Last Updated By</label>
				   <?php $sqlUserDetail = @mysqli_fetch_object(@mysqli_query($connNew,"SELECT `username` FROM `".TBL_USERS."` WHERE `id` = '".$rowUserDetail->last_modified_by."'"));?>
