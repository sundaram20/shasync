...
//$file_name = $company.'-'.$season.'.pdf';
$file_name =str_replace(array( '\'', '_', ' / ' , ';', '<', '>',' ' ), '-', urldecode($company)).'-'.$season.'.pdf';	
$_POST['sendcontent']='qwq';$_POST['subject']='sub';

 echo '<br>1==============='.'support@roomstatushub.com';
 echo '<br>2==============='.$_POST['mailId'];
 echo '<br>3==============='. $_POST['subject'];
 echo '<br>4==============='. $_POST['sendcontent'];
 
 echo '<br>5==============='. $_POST['ccId'];
 echo '<br>6==============='. $attachPath."mailattach/".$file_name;
 echo '<br>7==============='. ucwords($handeledby);
 echo '<br>8==============='. $handeledbyEmail;




	
$sent =  $sendMail->sendRateMails2('support@roomstatushub.com', $_POST['mailId'], $_POST['subject'],$_POST['sendcontent'],$_POST['ccId'],$attachPath."mailattach/".$file_name,ucwords($handeledby),$handeledbyEmail);
echo 'END===============';
print_r($_POST);
die;
if($sent){
