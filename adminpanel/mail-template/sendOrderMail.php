...
$content .= '<br/><table class="table" width="800">
						...
						<tr style="background-color: #4f81bc;color:#fff;">
						  ...
						  <td style="color:#fff;">'.$BookingStatus.'</td>
		...
		<td colspan="3"> <span style="font-size:15px;"><b> Amendment In : '.selectColumn(TBL_AMENDMENT_REMARKS,'name'," WHERE `am_id` = '".addslashes($rowOrder->amendment_remarks_id)."'").'       
...
$content .= '<table class="table" width="800">
						...
						<tr align="middle" tyle="background-color: #4f81bc;color:#fff; font-color:#fff; font-color:#fff;">

						   <th ><b>Booking Date</b></th>

						   <th ><b>Pax Details</b></th>
 ...
 $content .= '<table class="table" style="margin:0px !important;text-align:center;" width="800">
						<tr>
						  <td><b>Payment Details:</b> '.$rowOrder->payment_reference.'<br> </td>
...
$content .= '<table class="table" width="800">
						...
						<tr align="middle" style="background-color: #4f81bc;color:#fff; font-color:#fff; font-color:#fff;">
						   ...
						   <th style="color:#fff;"><b>Checkin Date</b></th>

						   <th style="color:#fff;"><b>Checkout Date</b></th>

						   <th style="color:#fff;"><b>Total Rooms</b></th>

						   <th style="color:#fff;"><b>Total Pax</b></th>

						  

						   <th style="color:#fff;"><b>Total Nights</b></th>

						   <th style="color:#fff;"><b>Mode of Payment / Status</b></th>							
			...
			while($rowOrderDetail=$db->fetch_object2($sqlOrderDetail)){
				...
				$content1 		+=$rowOrderDetail->child;

				$Totalinfants	=$rowOrder->total_infants;
			...
			if(num_rows($resRoom) >0){
				...
				$i++;
						   ...
						   $content .= '| Infants-'.$Totalinfants.'</td>
            ...
            <table class="table table-striped" width="800">
              ...
              <thead>
                ...
                <tr  align="middle"style="background-color: #4f81bc;color:#fff; font-color:#fff; font-color:#fff;">
				  ...
				  <th style="color:#fff;">Room Type</th>

				  <th style="color:#fff;">Total Room </th>

				  <th style="color:#fff;">Pax / Room</th>

				  <th style="color:#fff;">Rate / Night	</th>				  

				  <th style="color:#fff;">Room Total</th>
		...
		$resRatePlan = selectSql(TBL_RATE_PLAN,"where id='".addslashes($rowOrderDetail->rate_plan_id)."'",''); 
		  ...
		  $remarks	=	$resultRatePlan->remarks;
				...
				$content .=' <tr align="middle">
				  ...
				  <td>INR '.round($rowOrderDetail->total_price/$rowOrderDetail->room_quantity).'</td>
...
if($rowOrder->pickup =='Yes'){
	...
	?>			
          ...
          <div class="col-sm-12 text-muted  no-shadow" >
            ...
            <p><strong>Getting There:</strong> <br> Get Directions to the Hotel by clicking <a target="_blank" href="'.$resultHotelDetail->gmap_url.' ">here</a>.</p>
...
if($resultHotelDetail->bank_detail !=''){
	$bankArray = array();
	$bankArray = explode(",",$resultHotelDetail->bank_detail);
 $content .='<div class="row">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input class="form-control" placeholder="Subject:" name="subject" value="<?php echo "".$rowGuestDetail->title." "."".$rowGuestDetail->first_name." "."".$rowGuestDetail->last_name."   "."Reservation ID# ".$rowOrder->reference; ?>" data-parsley-required >
