...
$content .= "<table >
          ...
          font-size:10pt !important; '>
                ".selectColumn(TBL_RATE_MAIL_FORMAT,'description','WHERE id_shop="'.$_SESSION['shop'].'" AND id="28" AND type=2')."
            </td>
				</tr>
			</table>";
}
...
if($sent){
	...
	$updateDaily = "UPDATE daily_pickup SET count_renewal_reminder=count_renewal_reminder+1 WHERE id='".encryptor('decrypt',$_REQUEST['id'])."' ";
          ...
          <div class="box box-primary">
           ...
           <?php /*?> <img id="loadAni" src="loadingAni.gif"><?php */?>
            ...
            <div class="box-body">
              ...
              <div class="form-group">
            <lable>Subject</lable>
                <input class="form-control" placeholder="Subject:" name="subject" value="<?php echo " RENEWAL REMINDER FOR ".strtoupper($season) ?> ||  <?php echo strtoupper(selectColumn(TBL_SHOP,'name','WHERE id="'.$_SESSION['shop'].'" '));?>" data-parsley-required >
