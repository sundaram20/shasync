...
include_once("includes/reportFunctions-test.php");
...
if($_REQUEST['Download'] == 'Download'){
    if($_REQUEST['report_date']==''){
        ...
        $unitDate   =date('Y-m-d',strtotime($_REQUEST['report_date']));
    }
	unitExecutivePortFolioYearlyReport(NULL,$_SESSION['shop'],$_REQUEST['usernameid'],$unitDate,"",$conn,$objPHPExcel);
}
          ...
          <div class="box-body">
            ...
            <!--<div class="form-group col-sm-6">
              ...
              <div class="form-group col-sm-4">
                ...
                <input type="text" class="form-control pickerdate" placeholder="Enter end date" id="report_date" name="report_date" autocomplete="off" value="<?php echo $report_date;?>"  data-parsley-required>
