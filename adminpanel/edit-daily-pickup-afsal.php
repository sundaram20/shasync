...
$filterParams = http_build_query([
    ...
    'renewal_date'      => $_REQUEST['renewal_date'],
]);
...
<div class="content-wrapper"> 
  ...
  <section class="content">
    ...
    <input type="hidden" name="date_created"    value="<?php echo htmlspecialchars($_REQUEST['date_created'] ?? ''); ?>" />
    <input type="hidden" name="renewal_check"   value="<?php echo htmlspecialchars($_REQUEST['renewal_check'] ?? ''); ?>" />
    <input type="hidden" name="renewal_date"    value="<?php echo htmlspecialchars($_REQUEST['renewal_date'] ?? ''); ?>" />
