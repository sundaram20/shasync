...
$sql = " SELECT  `".TBL_RATE."`.* FROM `".TBL_RATE."`  WHERE `".TBL_RATE."`.`id_shop` = '".addslashes($_SESSION['shop'])."'  AND `".TBL_RATE."`.`company_id` = '0'  ";
...
if($_SESSION['HotelUserPermission'] != ''){//FIND_IN_SET('".$resActionId."',user_actions) 
	...
	$sql .= " ORDER BY  `".TBL_RATE."`.`status` DESC";
      ...
      <div class="col-xs-12">
        <div class="nav-tabs-custom">
          ...
          <div class="box-header with-border">
            ...
            <div class="btn-group  pull-right"><a type="button" class="btn btn-success" href="editRateMaster.php" >Add Rate</a>
...
?>     
                       ...
                       <a href="javascript://" onClick="showContent(<?php echo $FollowupExpand.','.$CountFollowup; ?>)" style="color:#fff;text-transform: uppercase;"><i class="fa fa-copy" style="color:rebeccapurple"> </i></a>
                        ...
                        &nbsp;&nbsp; <a href="editRateMaster.php?hotelId=<?php echo encryptor('encrypt',$hotelId);?>&id=<?php  echo encryptor('encrypt',$row->id);?>&action=edit&page=<?php echo $_REQUEST['page']; ?>" title="Edit"><i class="fa fa-pencil-square-o" ></i></a> 
