...
include_once("includes/reportFunctionsDemo.php");
...
if($_REQUEST['Download'] == 'Download'){
	...
	executivePortFolioYearlyReportDemo(NULL,$_SESSION['shop'],$_REQUEST['usernameid'],date('Y-m-d',strtotime($_REQUEST['report_date'])),"",$conn,$objPHPExcel);
}
