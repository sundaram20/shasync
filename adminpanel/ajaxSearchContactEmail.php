<?php include_once("../../config/auto_loader.php");
    ...
    $response = array();
   $SQL	= "
select *  from ".TBL_CUSTOMER." where type='2' and status='1' and id_shop='".addslashes($_SESSION['shop'])."'   AND email LIKE '{$key}%'  order BY email LIMIT 0,25
";
    ...
    while($row=mysqli_fetch_assoc($query))
    {
	  ...
	  $response[] = array('id'=>$row['id_customer'], 'text'=>$email);
