                ...
                <div class="box-header with-border">
                  <div class="btn-group  pull-right"> <a type="button" class="btn btn-success" href="javascript:void(0)"><i class="fa fa-fw fa-cloud-download"></i></a>
                    ...
                    <ul class="dropdown-menu" role="menu">
                      ...
                      <li><a title="Export to csv file" onclick="downloadSummaryPdfDetails(1,0);" href="javascript:void(0)"><img src="images/pdf.jpg" width="20" height="20">&nbsp;Pdf With Detail</a></li>
                    </ul>
                  </div>
                </div>
...
function fetchLeadPerformance(){
        ...
        $("#loading").show();
			...
			$.ajax({
				...
				type:'POST',
				data:'per_report_date='+per_report_date+'&id_team='+id_team+'&date_period='+date_period+'&ptype='+ptype+'&leadSummaryType=1',
...
function loadleadAward(date_period,ptype){
   ...
   downloadSummaryPdf = (pdf,excel) => {
            ...
            let filename1 =  'ajaxLeadAwardSummaryPeriod';
             let url1 = 'ajax/'+filename1+'.php?pdf='+pdf+'&excel='+excel+'&per_report_date='+per_report_date+'&id_team='+id_team+'&date_period='+date_period+'&ptype='+ptype+'&leadSummaryType=1&status=download';
            window.open(url1);
   ...
   downloadSummaryPdfDetails = (pdf,excel) => {
			...
			var id_team	=	$("#id_team").val();
            let filename1 =  'ajaxLeadAwardSummaryPeriod';
             let url1 = 'ajax/'+filename1+'.php?pdf='+pdf+'&excel='+excel+'&per_report_date='+per_report_date+'&id_team='+id_team+'&date_period='+date_period+'&ptype='+ptype+'&leadSummaryType=1';
            window.open(url1);
