...
function callingLoader(linkId){
 ...
 var eventSources  = 
    ...
    $('#calendar').fullCalendar('addEventSource', eventSources);
		...
		*/
	$('#calendar').fullCalendar('removeEventSource', 'ajax/ajaxDailyReportWithIncentive.php'); // Remove old event source
    $('#calendar').fullCalendar('addEventSource', {
        url: 'ajax/ajaxDailyReportWithIncentive.php',
        type: 'POST',
        data: {
            'Admin_user_id': linkId,
        },
        error: function() {
    ...
    // Refetch and render events from updated event source
