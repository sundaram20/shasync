...
?>
                ...
                <td><input type="text"  autocomplete="off"  name="dailypickup[<?php echo $k;?>][cost]" id="cost<?php echo $k;?>" placeholder="0"  class="form-control" value="<?php echo $rowsID->cost; ?>"  onkeyup="CostFormula(this.id,<?php echo $k;?>)" />
                ...
                <td><input type="<?php echo $TextBoxHidden; ?>"  autocomplete="off"  name="dailypickup[<?php echo $k;?>][total_cost]" id="total_cost<?php echo $k;?>" placeholder="0"  class="form-control" value="<?php echo $rowsID->total_cost; ?>"  readonly="" /></td>
                
                <td><input type="<?php echo $TextBoxHidden; ?>"  autocomplete="off"  name="dailypickup[<?php echo $k;?>][profit]" id="profit<?php echo $k;?>" placeholder="0"  class="form-control" value="<?php echo $rowsID->profit; ?>"  readonly="" /></td>
                
                <td><input type="<?php echo $TextBoxHidden; ?>"  autocomplete="off"  name="dailypickup[<?php echo $k;?>][points]" id="points<?php echo $k;?>" placeholder="0"  class="form-control" value="<?php echo $rowsID->points; ?>"  readonly="" /></td>
                
               <td> <input type="<?php echo $TextBoxHidden; ?>"  autocomplete="off"  name="dailypickup[<?php echo $k;?>][variable_in_rs]" id="variable_in_rs<?php echo $k;?>" placeholder="0"  class="form-control" value="<?php echo $rowsID->variable_in_rs; ?>"  readonly="" /></td>
