...
// ----------cate---------
 $sql = " SELECT * FROM `".TBL_CUSTOMER."` WHERE type='1' and `id_shop` = '".addslashes($_SESSION['shop'])."'";
	 ...
	 <div class="form-group has-error" align="center">
        ...
        <div class="box-header with-border">
		  ...
		  <div class="btn-group  pull-right">
							  <a type="button" class="btn btn-success" href="editGuests.php" >Add Guests</a>
            ...
            <div class="box-body table-responsive">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
				  ...
				  <td><img src="images/view_edit.gif" style="cursor:pointer;" title=" View / Edit " onClick="window.location.href='editGuests.php?id=<?=encryptor('encrypt',$row->id_customer)?>&action=edit&page=<?=$_REQUEST['page']?>';" />
				  &nbsp;&nbsp;&nbsp;&nbsp;				  
  		    ...
  		    if (this.readyState == 4 && this.status == 200) {
  		      ...
  		      if(this.responseText == 1){
  		      	...
  		      	if(confirm('Are you sure that you want to delete this record '+name+'?')){
  		      		window.location.href='manageGuests.php?delId='+id+'&action=delete&page=<?=$_REQUEST['page']?>';
  		      	}
  		      }
  		    }
  		  };
