...
.chartAreaWrapper {
  ...
  <tbody>
   ...
   <tr>
      ...
      <div class="box-body">
            <div class="chart"  style="height:600px; overflow-x: scroll; position: relative"> <div class="chartWrapper">
  <div class="chartAreaWrapper">
  <div class="chartAreaWrapper2">
              <canvas  style="height:600px; overflow-x: scroll; position: relative" id="mtdPerChart"></canvas>
            </div>
          </div>
          <!-- /.box-body --> 
        </div>
