...
?>
			    ...
			    <td><input type="text"  autocomplete="off"  name="dailypickup[<?php echo $k;?>][serial_number]" id="sr_no<?php echo $k;?>" placeholder="Enter Serial no" onkeyup="qtycalc_rows(this.id,<?php echo $k;?>)" class="form-control" value="<?php echo $rowsID->serial_number; ?>"/></td>
