	...
	if($err == 0){//No error
		if(($_POST['Save'] == 'Add') && empty($_POST['eId'])){//add
			...
			if(executeSql($addSql)){
				...
				header("location:manageProductTypes.php?eId=".encryptor(encrypt,$lastInsertId)."&submenu=".$_GET['submenu']."&action=edit&page=".$_REQUEST['page']);
				exit;
			}else{
				$err++;
		...
		//Update Section Here
			...
			if(executeSql($editSql)){
				...
				header("location:manageProductTypes.php?eId=".$_GET['eId']."&submenu=".$_GET['submenu']."&action=edit&page=".$_REQUEST['page']);
				exit;
			}else{
				$err++;
		...
		$err++;
		$_SESSION['errorMsg'] = 'Products Type details has not been saved. Please make corrections.';
	}
}
// ----------cate---------
        ...
        <div class="col-md-12">
          <!-- general form elements -->
			...
			<ul class="nav nav-tabs">
			   <li class="active" ><a href="#tab_1" data-toggle="tab">Product Types</a></li>  
            </ul>
            ...
            <!-- form start -->  			        
			 <form name="form1"  method="post" enctype="multipart/form-data" data-parsley-validate autocomplete="off" >
              ...
              <div class="box-body">
                  ...
                  <label for="name">Products Type<font color="#FF0000">*</font></label>
                  <div class="input-group"> 
              			<div class="input-group-addon">
							<i class="fa fa-ioxhost"></i> 
					   	</div>
                  <input type="text" class="form-control" placeholder="Enter Products Type" id="field_value" name="field_value" value="<?php if($_POST) echo $_POST['field_value'];else echo stripslashes($row->field_value);?>"  data-parsley-required>
			 ...
			 <div class="box-footer">                                       
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
			   <input type='button' value='Close' class="btn btn-danger" onclick='location.replace("manageProductTypes.php"); '>
			 </div>
            </form>			
          </div>
          <!-- /.box -->
