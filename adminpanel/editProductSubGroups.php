	...
	if($err == 0){//No error
		if(($_POST['Save'] == 'Add') && empty($_POST['eId'])){//add
			...
			if(executeSql($addSql)){
				...
				$_SESSION['successMsg'] = 'New Sub Group details has been added sucessfully.';
				header("location:manageProductSubGroups.php?eId=".encryptor(encrypt,$lastInsertId)."&action=edit&page=".$_REQUEST['page']);
				exit;
			}else{
				$err++;
				$_SESSION['errorMsg'] = ' Sub Group details has not been saved. Please make corrections below.';
			}
		...
		//Update Section Here
			...
			if(executeSql($editSql)){
				...
				header("location:editProductSubGroups.php?eId=".$_GET['eId']."&action=edit&page=".$_REQUEST['page']);
				exit;
			}else{
				$err++;
		...
		$err++;
		$_SESSION['errorMsg'] = 'Sub Group details has not been saved. Please make corrections.';
	}
}
// ----------cate---------
...
<div class="content-wrapper">
	...
	<section class="content-header">
      <h1>
        Sub Group 
        <small>Manage Sub Groups</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage Sub Groups</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <!-- general form elements -->
			...
			<ul class="nav nav-tabs">
			   <li class="active" ><a href="#tab_1" data-toggle="tab"> Sub Group</a></li> 
            </ul>
            ...
            <!-- form start -->  			        
			 <form name="form1"  method="post" enctype="multipart/form-data" data-parsley-validate autocomplete="off" >
              ...
              <div class="box-body">
				 ...
				 <div class="form-group">
                  <label for="name"> Sub Group Name<font color="#FF0000">*</font></label>
                  <div class="input-group"> 
              			<div class="input-group-addon">
							<i class="fa fa-object-group"></i> 
					   	</div>
                  <input type="text" class="form-control" placeholder="Enter Sub Group Name" id="field_value" name="field_value" value="<?php if($_POST) echo $_POST['field_value'];else echo stripslashes($row->field_value);?>"  data-parsley-required>
			 ...
			 <div class="box-footer">                                       
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
			   <input type='button' value='Close' class="btn btn-danger" onclick='location.replace("manageProductSubGroups.php"); '>
			 </div>
            </form>			
          </div>
          <!-- /.box -->
