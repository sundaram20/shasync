...
$reportArray=array();
//LASTYEAR SQL START >>================================================================================================================	
if(($_REQUEST['pdf']==1 ) || ($_REQUEST['summaryReportType'] == '1' )){//Team Wise  Summary PDF reportType Pickup Report
$GroupOrder =  "  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_COMPANY."`.id_default_group Order BY `mst_team`.id_group,`fs_users`.myownteam_id";

}
if(($_REQUEST['pdf']==1 ) || ($_REQUEST['summaryReportType'] == '2' )){//Executivewise  Summary PDF PICK ASE
$GroupOrder = "  GROUP BY `".TBL_USERS."`.myownteam_id,`fs_users`.id,`".TBL_ORDERS."`.id_company Order BY `mst_team`.id_group,`fs_users`.myownteam_id";
}
if(($_REQUEST['pdf']==1 ) || ($_REQUEST['summaryReportType'] == '3' )){//Hotel Wise  Summary PDF PICKUP Report
...
//LASTYEAR SQL END >>  ================================================================================================================
 ...
 if(($_REQUEST['pdf']==1 && $_REQUEST['reportType']==1) || ($_REQUEST['summaryReportType'] == '1' && $_REQUEST['reportType']==1)){//Team Wise  Summary PDF reportType Pickup Report
    ...
    $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
       ...
       ".$cond.$allUser."  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_COMPANY."`.id_default_group Order BY `mst_team`.id_group,`fs_users`.myownteam_id";
 ...
 if(($_REQUEST['pdf']==1 && $_REQUEST['reportType']==2) || ($_REQUEST['summaryReportType'] == '1' && $_REQUEST['reportType']==2)){//Team Wise  Summary PDF reportType BOB Report
...
if(($_REQUEST['pdf']==1 && $_REQUEST['reportType']==1) || ($_REQUEST['summaryReportType'] == '2' && $_REQUEST['reportType']==1)){//Executivewise  Summary PDF PICK ASE
    ...
    $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
       ...
       ".$cond.$allUser."  GROUP BY `".TBL_USERS."`.myownteam_id,`fs_users`.id,`".TBL_ORDERS."`.id_company Order BY `mst_team`.id_group,`fs_users`.myownteam_id";
      //echo $sql;
      //die;
     //  LEFT JOIN  `".TBL_TEAM."` ON `".TBL_TEAM."`.ids_team REGEXP CONCAT('(^|,)(', REPLACE('".$id_teams."', ',', '|'), ')(,|$)') AND  FIND_IN_SET(myownteam_id,'".$id_teams."') 
       $SummaryHedding='Executivewise  ';
...
if(($_REQUEST['pdf']==1 && $_REQUEST['reportType']==2) || ($_REQUEST['summaryReportType'] == '2' && $_REQUEST['reportType']==2)){//Executivewise  Summary PDF Bob
...
if(($_REQUEST['pdf']==1 && $_REQUEST['reportType']==1) || ($_REQUEST['summaryReportType'] == '3' && $_REQUEST['reportType']==1)){//Hotel Wise  Summary PDF PICKUP Report
    ...
    $sql = " SELECT `".TBL_ORDERS."`.id_hotel,`".TBL_ORDERS."`.id_company,`mst_team`.id_group,`fs_users`.myownteam_id as MyOwnteam,`".TBL_COMPANY."`.id_default_group,`".TBL_USERS."`.id AS id_executive,`".TBL_AREAS."`.id AS id_area,`".TBL_ORDERS."`.booking_status,`".TBL_USERS."`.ids_team,
       ...
       ".$cond.$allUser."  GROUP BY `".TBL_USERS."`.myownteam_id,`".TBL_ORDERS."`.id_hotel,`".TBL_USERS."`.name Order BY `mst_team`.id_group,`fs_users`.myownteam_id";
      //echo $sql;
      //die;
     //  LEFT JOIN  `".TBL_TEAM."` ON `".TBL_TEAM."`.ids_team REGEXP CONCAT('(^|,)(', REPLACE('".$id_teams."', ',', '|'), ')(,|$)') AND  FIND_IN_SET(myownteam_id,'".$id_teams."') 
       $SummaryHedding='Hotel Wise ';
 ...
 if(($_REQUEST['pdf']==1 && $_REQUEST['reportType']==2) || ($_REQUEST['summaryReportType'] == '3' && $_REQUEST['reportType']==2)){//Hotel Wise  Summary PDF BOP
...
foreach($reportArray as $maintitle=>$mainDatalist){
	...
	$contentTeam .='<tr><th colspan="8" style="vertical-align:central;text-align:center;color:#fff;background-color:#4f6228; font-size:16px !important"><b>Compare '.$maintitle.'  Breakup For Period '.$reportPeriod.'</b></th></tr>';
    $contentTeam .='<tr>
...
//Sorting Order Number Height to Low
      ...
      foreach($subDataList as $list=> $DataList){
           if($DataList['roomnights']>0 || $DataList['lastYearroomnights']>0){
                 if($DataList['confimed_revenue']>0 || $DataList['lastYearconfimed_revenue']>0){
                        ...
                        $contentTeamBody .='<td style="text-align:center;">'.$golyRowWiseRoomNights.'</td>';
                        
                        $contentTeamBody .='<td style="text-align:center;">'.($DataList['lastYearconfimed_revenue']>0?$DataList['lastYearconfimed_revenue']:'0').'</td>';
                        $contentTeamBody .='<td style="text-align:center;">'.($DataList['confimed_revenue']>0?$DataList['confimed_revenue']:'0').'</td>';
                        $contentTeamBody .='<td style="text-align:center;">'.$golyRowWiseConfimedRevenue.'</td>';
            ...
            if($TotalTeamRoomNight>0){
                ...
                <th  style="vertical-align:central;text-align:center;color:#000;background-color:#e2f7b8; font-size:12px !important"><b>'.$SumTeamTotalgolyRoomNights.'</b></th>
                
               
                
                <th  style="vertical-align:central;text-align:center;color:#000;background-color:#e2f7b8; font-size:12px !important"><b>'.$TotalTeamConfimedRevenuelastYear.'</b></th>
                <th  style="vertical-align:central;text-align:center;color:#000;background-color:#e2f7b8; font-size:12px !important"><b> '.$TotalTeamConfimedRevenue.'</b></th>
                <th  style="vertical-align:central;text-align:center;color:#000;background-color:#e2f7b8; font-size:12px !important"><b>'.$SumTeamTotalgolyConfimedRevenue.'</b></th>
    ...
    <td style="border-left:1px solid #fff;background-color:#c2d69a;text-align:center;">'.$SumTotalGolyRoomNights.'</td>
    
    <td style="border-left:1px solid #fff;background-color:#c2d69a;text-align:center;">'.$TotalConfimedRevenuelastYear.'</td>
    <td style="border-left:1px solid #fff;background-color:#c2d69a;text-align:center;">'.$TotalConfimedRevenue.'</td>
    <td style="border-left:1px solid #fff;background-color:#c2d69a;text-align:center;">'.$SumTotalGolyConfimedRevenue.'</td>
    ...
    $TotalConfimedRevenuelastYear='';
     ...
     $contentTeam .= '</table><br/><br/>';
         ...
         if($maintitle=='Team Wise'){
        	 ...
        	 <th colspan="8" style="vertical-align:central;text-align:center;color:#fff;background-color:#4f6228; font-size:16px !important"><b>'.$maintitle0ch.' Groupwise Summary For Period '.$reportPeriod.'</b></th></tr>	';
              $contentGroup .='<tr>
    <th   style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a;">Name</th>
    <th colspan="3" style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a;">Room Nights</th>
    <th colspan="3"  style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a; ">Revenue</th>
    ...
    $contentGroup .=    '<tr >
             ...
             <th style="vertical-align:central;text-align:center;color:#000;background-color:#c2d69a;">&nbsp</th>
                 ...
                 foreach($GroupArray as $name => $GroupNameArray){
                    ...
                    $contentGroup .='<td style="text-align:center;">'.$GroupNameArray['lastYearconfimed_revenue'].'</td>';
                    $contentGroup .='<td style="text-align:center;">'.$GroupNameArray['RoomRevenue'].'</td>';
                    $contentGroup .='<td style="text-align:center;">'.$GolyGroupRoomRevenue.'</td>';
             ...
             <td style="border-left:1px solid #fff;background-color:#c2d69a;text-align:center;">'.$TotalTeamWiseConfimedRevenuelastYear.'</td>
             <td style="border-left:1px solid #fff;background-color:#c2d69a;text-align:center;">'.$TotalTeamWiseConfimedRevenue.'</td>
