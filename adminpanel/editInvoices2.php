  ...
  <section class="content">
    ...
    <div class="box box-primary">
      <div class="box-header with-border" id="recentAdd" style="border:1px solid #252525; border-radius:3px;display: none; ">
        <h3 class="box-title" style="color: green;">Recently Added Invoice :</h3>
      ...
      <div class="box-header with-border">
        <h3 class="box-title"><?php echo $_REQUEST['eId']==''?'Add':'Edit'?> Invoice</h3>
      </div>
...
$date1	=date('d-m-Y');
    ...
    // 24 * 60 * 60 = 86400 seconds 
     $DateNoDays = abs(round($diff / 86400)); 
              ...
              <input type="text" class="form-control pickerdate_addreport" placeholder="Enter Invoice No" id="invoiceno" name="invoiceno" value="<?php echo  $invoiceno; ?>"  data-parsley-required>
            ...
            <div class="col-md-6" >
              <div class="form-group">
                <label for="start_date">Hotel Name<font style="color:red;">*</font></label>
                <?php 
                     	if($row->hotel_id==0){
           ...
           <div class="form-group col-md-3">
              ...
              <label for="invoiceno">Source:</label>
              <input type="text" class="form-control " placeholder="Enter Source " id="entityname" name="entityname" value="<?php echo  $entityname; ?>"  data-parsley-required>
            ...
            <label for="id_guest" >Guest Name</label>
             <input type="text" class="form-control " placeholder="Enter Guest Name " id="entityname" name="entityname" value="<?php echo  $entityname; ?>"  data-parsley-required>
        ...
        <?php 
          ...
          <div class="form-group col-md-3">
              ...
              <input type="text" class="form-control " placeholder="Enter Amount " id="amount" name="amount" value="<?php echo  $invoiceno; ?>"  data-parsley-required>
              <?php echo $err_invoiceno;?> </div>    
              ...
              <input type="text" class="form-control " placeholder="Enter Received Amount" id="received" name="received" value="<?php echo  $invoiceno; ?>"  data-parsley-required>
              <?php echo $err_invoiceno;?> </div>  
              ...
              <input type="text" class="form-control " placeholder="Enter Balance" id="balance" name="balance" value="<?php echo  $invoiceno; ?>"  data-parsley-required>
              <?php echo $err_invoiceno;?> </div>
          ...
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <?php if($_REQUEST['eId']==''){?>
                <a class="pull-left btn btn-success btn-xs" onclick="addEqyFollowUp(0);" <?php echo $disabled ?> type="button" id="enqFollowUp" >Add Follow Ups</a>
                <?php }else{?>
                <a class="pull-left btn btn-success btn-xs" <?php echo $disabled ?> type="button" >Add Follow Ups </a>
                <?php }?>
              </div>
...
?>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label for="image" style="float:left;">Payment&nbsp;&nbsp; </label>
              <?php /*?>  <button type="button" class="pull-left btn btn-success btn-xs" data-toggle="modal" data-target="#paymentModal">
  Add Payment
</button><?php */?>
<a href="javascript:void(0)" onClick="addNewGrid();" class="pull-left btn btn-success btn-xs" ><i class="fa fa-plus fa-x1 "></i>  Add Payment</a> </div>
              </div>
              
            </div>
          </div>
          
          <?php include('InvoicePaymentPopup.php');?>
          <div class="box">
                ...
                <table id="example2" class="table table-bordered table-striped">
                  <thead>
                    <tr> 
                      ...
                      <th>Forward To</th>
                      <th>Action Date</th>
                      <th>Payment Internal Remarks</th>
                      <th>Status</th>
                      <th>Action</th>
                    </tr>
                  </thead>
...
?><div class="box-body" id="rowGrid"></div>
          </div>
        ...
        <div class="box-footer">
          ...
          <input type='button' <?php echo $NextFollowUpDisable; ?> value='<?=($_REQUEST['eId']==''?'Add':'Edit')?>' class="btn btn-primary" name="Save" onClick="SaveSalesReport--();">
          &nbsp;&nbsp;&nbsp;&nbsp;
...
//COMPANY AUTO COMPLETE START==================================================================
  ...
  var gridNo=5;
	function addNewGrid(){
         ...
         var grid = ""; 
          grid +='<div class="row" id="grid'+gridNo+'" >';  	
		grid +='<!-- <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button> <h4 class="modal-title" id="myModalLabel">Modal title</h4> </div>--> <div class="modal-body p-0"> <div class="row"> <div class="col-md-12"> <div class=""> <div class="box-body table-responsive" > <table id="myTableOrder1" class="table dataTable no-footer table-responsive" cellspacing="0" style=""> <thead style=""> <tr > <th></th> <th style=""> Payment Mode.&nbsp;</th> <th style="">Amount</th> <th style="">Remarks</th> </tr></thead> <tbody> <tr id="trbgcolor"> <td style="width: 2.5%;"><div class="" aria-checked="false" aria-disabled="false" > <input type="checkbox" class="flat-red i-checks " name="checkboxpayamount" id="checkboxpayamount" value="" > </div></td><td><div class="info-box paymentmode sales-info"> <span class="info-box-icon paymode-span"> <img src="images/cashpay.png" class="img-responsive" style="cursor:pointer;" title="Cash"> </span> <div class="info-box-content"> <span class="info-box-text">CASH</span> </div></div></td><td><input type="text" class="form-control first-input billingamount_39498" style="float: left;" data-parsley-required="" data-parsley-errors-container="#payamountError"></td><td><input type="text" class="form-control first-input" placeholder="Remarks" style="float: left;" ></td></tr><tr style="background-color:#fff;" > <td style="width: 2.5%;"><div class="icheckbox_flat-green" aria-checked="false" aria-disabled="false" > <input type="checkbox" class="flat-red i-checks " name="checkboxpayamount" id="checkboxpayamount" value="" data-parsley-multiple="checkboxpayamount" > <ins class="iCheck-helper" style=""></ins> </div></td><td><div class="sale-info"> <div class="info-box sales-info" > <span class="info-box-number"> <div class="box-body" style="width:2%;float: left;padding: 0px !important;height: 60px;margin-left: 16px;"> <div class="form-group"> <div> <label for="name" class="paymentlable"> <div class="iradio_flat-green" aria-checked="false" aria-disabled="false"> <input type="radio" class="flat-red" value="1" name="" id="cardtype" style="position: absolute; opacity: 0;" > <ins class="iCheck-helper" style=""></ins> </div></label> </div><img class="visaimg" src="images/visa.png" alt="Visa"> </div></div><div class="box-body upibox" style=""> <div class="form-group" > <div> <label for="name" class="paymentlable"> <div class="iradio_flat-green" aria-checked="false" aria-disabled="false" > <input type="radio" class="flat-red" value="2" name="" id="cardtype" data-parsley-multiple="" > <ins class="iCheck-helper" ></ins> </div></label> </div><img class="upiimg" src="images/upi.png" style="cursor:pointer;" title="upi"> </div></div><div class="box-body neftbox"> <div class="form-group"> <div> <label for="name" class="paymentlable"> <div class="iradio_flat-green" aria-checked="false" aria-disabled="false" > <input type="radio" class="flat-red" value="3" name="" id="cardtype" data-parsley-multiple="" style=""> <ins class="iCheck-helper" style=""></ins> </div></label> </div><img class="neftimg" src="images/neft.png" style="cursor:pointer;" title="upi"> </div></div></span> </div></div></td><td style="width: 12.5%;"><input type="text" class="form-control" value="0" style="float: left;" data-parsley-required="" data-parsley-errors-container="#payamountError"></td><td style="width:100%;" class="d-flex"><input type="text" class="form-control first-input" placeholder="Remarks" name="" id="" value="" style="float: left;"> <div> <div class="bankbox"> <select class="form-control first-input select2 select2-hidden-accessible" style="width:100% !important;" name="" id="" tabindex="-1" aria-hidden="true"> <option value="0">--- Select Bank --- </option> <option value="1">Amex Credit </option> <option value="2">Bank2 </option> </select> </div></div></td></tr><tr id="trbgcolor"> <td colspan="5" style="padding:0px !important;"><div id="rowGrid_39498"></div></td></tr><tr id="trbgcolor"> <td style="width: 2.5%;"><div class="icheckbox_flat-green" aria-checked="false" aria-disabled="false" > <input type="checkbox" class="flat-red i-checks " name="checkboxpayamount" id="checkboxpayamount" data-parsley-multiple="checkboxpayamount" > <ins class="iCheck-helper" ></ins> </div></td><td><div class="info-box paymentmode sales-info"> <span class="info-box-icon paymode-span"> <img src="images/cheq.png" style="cursor:pointer;" title="Cheque"> </span> <div class="info-box-content"> <span class="info-box-text">CHEQUE</span> </div></div></td><td><input type="text" class="form-control" value="0" style="float: left;" data-parsley-required="" data-parsley-errors-container="#payamountError"></td><td><input type="text" class="form-control first-input" placeholder="Remarks" name="" id="" value="" style="float: left;"></td></tr></tbody> </table> </div></div></div></div>';
		/*grid +='<div class="col-md-2"><div class="form-group"><label>Payment Type</label><select class="select3 form-control" name="id_payment['+gridNo+'][]" name="id_payment'+gridNo+'"  ><option value="">---Select Payment ---</option><option value="">Cash</option><option value="">Card</option><option value="">Cheque</option></select></div></div><span class="info-box-icon  paymode-span"> <img src="images/cashpay.png" class="img-responsive"  style="cursor:pointer;" title="Cash"> </span>';
		
		grid +='<div class="box box-sucess box-solid">';
		
		grid +='<div class="col-md-2">                              <div class="form-group">                <label for="room">Payment Date <font color="#FF0000">*</font></label>      <input  type="text" class="form-control pull-right pickerdate_addreport"  id="promocode_booking_date'+gridNo+'" name="promocode_booking_date[]" data-parsley-required value="" data-parsley-errors-container="#effective_dateError"  autocomplete="off"   >                       </div></div></div>';
		
		
	  grid +='<div class="col-md-3">              <div class="form-group">                <label for="room">Amount<font color="#FF0000">*</font></label>                <input required   placeholder=" Enter Amount " class="form-control" type="text" id="amount" value=""  name="amount[]"> </div></div>';
		
		grid +=' <div class="col-md-3">              <div class="form-group">                <label for="room">Remarks<font color="#FF0000">*</font></label>                <input required   placeholder="Enter Remarks " class="form-control" type="text" id="remark" value=""  name="remark[]"> </div></div>';*/
		
		       grid +='<div class="col-md-1">              <div class="form-group">                <label for="room">&nbsp;</label>           <a href="javascript:void(0)" onclick="removeGrid('+gridNo+');" class="form-control btn btn-danger" ><i class="fa fa-remove fa-x1 "></i> </a>                              </div>';
