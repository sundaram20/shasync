      ...
      <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
			...
			<!--Smtp Detail--->
              <div class="form-group">
                  <label for="company_credibility">User Custom SMTP </label>
      ...
      <?php 
           ...
           <div  <?php echo $dispalyBox;?>  id="usercustomsmtp">       
              ...
              <div class="form-group col-sm-6">
                  ...
                  <label for="display_order">Email ID</label>

                  <input type="text" class="form-control" placeholder="Enter Smtp Email" id="smtp_email" <?php echo $required?> name="smtp_email" value="<?php if($_POST) echo $_POST['smtp_email'];else echo stripslashes($rowUserDetail->smtp_email);?>">
                ...
                <div class="form-group col-sm-6">
                  ...
                  <input type="password" <?php echo $required;?> class="form-control" placeholder="Enter Smtp Password" id="smtp_password" name="smtp_password" value="<?php if($_POST) echo $_POST['smtp_password'];else echo stripslashes($rowUserDetail->smtp_password);?>">
