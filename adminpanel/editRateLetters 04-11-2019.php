            ...
            <div class="box-header">
			  ...
			  <div class="form-group col-sm-4">
                  <label for="seasonId">Company-City <font color="#FF0000">*</font> </label>
                   <select required="required" class="form-control select2" name="company_id" id="company_id" data-parsley-errors-container="#companyError" data-parsley_required <?php //echo $disabled; ?> onChange="getCompanyGuestName(this.value,'');areaExecutive(this.value); companyInsideZone();" ><option value="">Select Company</option>
								 <?php			  $resCat = selectSql(TBL_COMPANY," where name !='' and status='1' and id_shop='".addslashes($_SESSION['shop'])."'   ",' ORDER BY `name`');
...
<?php 		}				 ?>
	...
	//echo $resultCat->id.'|'.$resultCat->rate_level_id .'=='. $row->id.'|'.$row->rate_level_id;
			//echo "SELECT `".TBL_RATE."`.*, `".TBL_RATE_LEVEL."`.name as level_name ,`".TBL_RATE_LEVEL."`.id as rate_level_id ,`".TBL_RATE_MARKET."`.name as market_name from `".TBL_RATE."` LEFT JOIN `".TBL_RATE_LEVEL."` ON `".TBL_RATE."`.rate_level_id=`".TBL_RATE_LEVEL."`.id   LEFT JOIN `".TBL_RATE_MARKET."` ON `".TBL_RATE."`.market=`".TBL_RATE_MARKET."`.id where   `".TBL_RATE."`.id_shop='".addslashes($_SESSION['shop'])."'  and (`".TBL_RATE."`.company_id='".$row->id_company."' || `".TBL_RATE."`.company_id='0' )"		?>            
                  ...
                  <?php $seasonDropDown = '<select class="form-control select2" name="seasonId" id="seasonId" data-parsley-errors-container="#seasonError" onchange="getseasonDate(this.value); ajaxMasterRateLetterLoad(this.value); rateLetterMasterFunction();" data-parsley-required '.$disabled.' >
              ...
              <div class="row">
               <?php
				...
				<div class="form-group col-sm-3">
                  ...
                  <select class="form-control" name="rate_level_id" id="rate_level_id" data-parsley-required data-parsley-errors-container="#rate_level_idError" onchange="updateLevelAndMarket(); rateLetterMasterFunction();getGeneralTerms(0,1,this.value);" <?php  echo $disabled ?>>
               ...
               <!-- <div class="form-group col-sm-4">
                  ...
                  <?php $marketDropDown = '<select class="form-control  select2 input-sm" name="new_rate_level_id" id="new_rate_level_id" data-parsley-errors-container="#new_rate_level_idError" onchange="getGeneralTerms(this.value,1);rateLetterMasterFunction();"   data-parsley-required  '.$disabled.'>
												  <option value="">Select Rate Level</option>';
                ...
                <div class="form-group col-sm-3">
                  ...
                  <?php $marketDropDown = '<select class="form-control  select2 input-sm" name="market" id="market" data-parsley-errors-container="#marketError" onchange="rateLetterMasterFunction();"  data-parsley-required   >
           ...
           <?php }  ?>        
              ...
              <div class="row">
                <div class="form-group col-sm-4">
					  ...
					  <?php $hotelDropDown = '<select class="form-control select2" name="hotelId" id="hotelId" data-parsley-errors-container="#hotelError" onchange="getRoom(this.value,1); rateLetterMasterFunction(); getInclusionDetail(this.value);" data-parsley-required >
												  <option value="">Select Hotel</option>';
 ...
 <?php 
          ...
          <form name="form1" id="rateUpdate"  method="post" enctype="multipart/form-data" role="form" data-parsley-validate autocomplete="off">
            ...
            <div style="float: left;width: 1100px;">
                 ...
                 <div class="form-group col-sm-4">
                  <label for="userlevelId">Rate Points<font color="#FF0000">*</font></label>
                  ...
                  <?php 
					...
					while($resUserActions = $db->fetch_object2($sqlUserActions)){
						...
						elseif(in_array($resUserActions->id,$ratePoints)){
							$selected = 'selected="selected"';
...
var HotelDuplicateInsert	=	$("input[type=radio]:checked").val();
		  ...
		  $.ajax({
			   type: "POST",
			   url: 'ajax/ajaxSaveDuplicateRate.php',
