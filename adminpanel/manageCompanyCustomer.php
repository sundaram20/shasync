...
$booking_date= explode(" to ",$_REQUEST['booking_date']);
	...
	$to_book = $booking_date['1'];
			...
			$sql .= " AND DATE(B.date_created) >='".date('Y-m-d',strtotime($from_book))."' AND DATE(B.date_created) <= '".date('Y-m-d',strtotime($to_book))."' ";	
        ...
        <div class="box-body">
		  ...
		  <div class="col-md-3">
            ...
            <div class="form-group col-sm-4">
                                ...
                                <label for="booking_date">&nbsp;Generation Date  : From - To</label>
