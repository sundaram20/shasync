...
$date1	=date('d-m-Y');
    ...
    $DateNoDays = abs(round($diff / 86400)); 
			  ?>
  <label for="start_date">Date:<font style="color:red;">*</font></label>
  <input type="text" class="form-control pickerdate_addreport" placeholder="Enter Enquiry date" id="enquiryDate" name="enquiryDate" value="<?php echo $report_date; ?>" data-parsley-required required>
  <?php echo $err_start_date; ?>
</div>
			  
<div class="form-group col-md-2">
  <label for="enquiryTime">Time:<font style="color:red;">*</font></label>
  <input type="time" class="form-control" id="enquiryTime" name="enquiryTime" 
         value="<?php echo (!empty($row->dated) && $row->dated != '0000-00-00') ? date('H:i', strtotime($row->dated)) : date('H:i'); ?>" 
  ...
  <input type="text" class="form-control" placeholder="Enter IP Address" 
         ...
         value="<?php echo !empty($row->ip_address) ? stripslashes($row->ip_address) : ''; ?>">
</div>

<div class="form-group col-md-6">
  <label for="gclid">GCLID</label>
  <input type="text" class="form-control" placeholder="Enter GCLID" 
         id="gclid" name="gclid" 
         value="<?php echo !empty($row->gclid) ? stripslashes($row->gclid) : ''; ?>">
</div>
