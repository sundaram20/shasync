...
if($_REQUEST['Download']=='Download'){
	...
	$shop_id	=	$_SESSION['shop'];
		...
		if(!isset($cron)){
			...
			->setCellValue('A6', 'Sales Activity Summary Report   '.date('d M-Y',strtotime($checkin)).' To '.date('d M-Y',strtotime($checkout)));
			...
			->setCellValue('A6', 'Sales Activity Summary  '.date('d M-Y',strtotime($checkin)).' To '.date('d M-Y',strtotime($checkout)));
...
cellColor('A7:E7','75923c');
	...
	$objPHPExcel->getActiveSheet(1)->getColumnDimension('D')->setWidth(55);
        ...
        <div class="col-xs-12">		     
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title">Sales Activity List</h3>
