...
include_once($path."/adminpanel/includes/reportFunctionsFollowupNotificationGcs.php");
   ...
   $rowTeam->name.$rowTeam->id;
	...
	// Head Email
		...
		$UserId = $rowTeam->id;
		 ...
		 echo $checkout = date('d-m-Y');
		 
		$ContentTable='';
		$mailContent='';
		echo $ContentTable=followUpNotificationsReportGcs($connNew,$shop_id,$cron,$checkin,$checkout,$UserId);
		 if($ContentTable!=''){
	...
	echo $sub = 'Gcs Pending Follow ups';
