...
//error_reporting(E_ALL);
//Cron Path
include_once($path."/adminpanel/includes/reportFunctions_new.php");
...
$season =array();
 $seasonSql = "SELECT id FROM ".TBL_RATE_SEASON." WHERE id_shop=".$id_shop."  AND status=1  and id IN('86','87')";
...
//$hotelSql = "SELECT id FROM ".TBL_HOTELS." WHERE id_shop=".$id_shop." AND status=1  order by id ASC limit 0,30";
$hotelSql = "SELECT id FROM ".TBL_HOTELS." WHERE id_shop=".$id_shop." AND id IN ('83','85')  AND status=1  ORDER BY display_order";
