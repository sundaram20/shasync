...
include_once($path."/adminpanel/includes/reportFunctionsFollowupNotificationDemo.php");
...
$DB_HOST                        = "ls-fe9795ed24d236257aec9c2c540e75e322c1c9d3.ck2rf8frnqrs.ap-south-1.rds.amazonaws.com";
	...
	$DB_PASSWORD                    = "Welcom@123";              // Password for he Db User
	$DB_NAME                        = "inroomhu_fern";              // Database name
...
/************** Setting Variables **********************/
 ...
 $sqlTeam  = "SELECT * FROM ".TBL_USERS." WHERE id_shop='6' and status='1'";
...
while($rowTeam = mysqli_fetch_object($resTeam)){
   $rowTeam->name.$rowTeam->id;
	...
	$sub = '13 -Testing - Pending Follow ups';

	$mailContent .= "Dear ".$rowTeam->name.",<br/><br/>";
	$mailContent .= "To: ".$to."ALL=  ".implode(',',$cc)."You have below Follow ups Pending.<br/><br/>";
