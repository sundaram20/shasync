...
<?php } 
                ...
                <div class="form-group col-sm-4">
                  ...
                  <select class="form-control select2" name="id_company" id="id_company" onChange="getExecutiveName(this.value,''); areaExecutive();" data-parsley-errors-container="#companyError" data-parsley-required >

                    <option value="">Select Company</option>

                    <?php $resCat = selectSql(TBL_COMPANY," where status='1' and `id_shop` = '".addslashes($_SESSION['shop'])."' and name !=''   ",' ORDER BY `name` ');
    ...
    width: 13.667%;
             ...
             <div class="col-md-5">                  
                ...
                <div class="form-group">
                  ...
                  <input type="text" <?php echo $readonly ?> class="form-control calTotal" name="KmsRun" id="KmsRun"  value="<?php if($_POST) echo $_POST['KmsRun'];else echo stripslashes($row->KmsRun);?>"  placeholder="Enter Kms Run" automcomplete="off"  data-parsley-errors-container="#KmsRunError">
                ...
                <div class="form-group">
                  ...
                  <input type="text" <?php echo $readonly ?> class="form-control calTotal" name="RateKm" id="RateKm"  value="<?php if($_POST) echo $_POST['RateKm'];else echo stripslashes($row->RateKm);?>"  placeholder="Enter Rate / Km" automcomplete="off"  data-parsley-errors-container="#RateKmError">
                ...
                <div class="form-group">
                  ...
                  <input type="text" <?php echo $readonly ?> class="form-control calTotal" name="Parking" id="Parking"  value="<?php if($_POST) echo $_POST['Parking'];else echo stripslashes($row->Parking);?>"  placeholder="Enter Parking" automcomplete="off"  data-parsley-errors-container="#ParkingError">
                ...
                <div class="form-group">
                  ...
                  <label for="Total">Entertainment(if any) </label>

                  <input type="text" <?php echo $readonly ?> class="form-control" name="entertainment" id="entertainment"  value="<?php if($_POST) echo $_POST['entertainment'];else echo stripslashes($row->entertainment);?>"  placeholder="Enter Entertainment " automcomplete="off"  data-parsley-errors-container="#EntertainmentError">
                  ...
                  <input type="text" <?php echo $readonly ?> class="form-control calTotal" name="lunch" id="lunch"  value="<?php if($_POST) echo $_POST['lunch'];else echo stripslashes($row->lunch);?>"  placeholder="Enter Lunch " automcomplete="off"  data-parsley-errors-container="#LunchError">
                  <?php echo $err_Total;?> </div>
...
<div class="form-group" style="padding: 20px 20px; border:1px solid #C0C0C0;border-radius: 5px;">
       ...
       <?php } echo $err_supervisor_remarks;*/?></div>
              ...
              <input type='hidden' id="Save" value='<?=($_REQUEST['eId']==''?'Add':'Edit')?>' class="btn btn-primary" name="Save">
                ...
                <input type='button' value='Cancel' class="btn btn-danger" onclick='location.replace("editDailyReport.php"); '/>
...
<?php } ?>	
 ...
 function SaveSalesReport(){
	...
	$.ajax({
	   ...
	   url: 'ajax/ajaxUpdateSalesReport.php',	   
