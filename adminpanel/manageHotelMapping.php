	 ...
	 <div class="form-group has-error" align="center">
        ...
        <div class="box-header with-border">
		  ...
		  <div class="btn-group  pull-right">
                  ...
                  <?php /*?>  <li><a title="Export to excel file" href="exportTable.php?fileType=xls&tableName=<?php echo TBL_HOTEL_MAPPING;?>"><img src="images/excel-icon.jpg" width="20" height="20" />&nbsp;Export</a></li>
              ...
              <div class="form-group">
                <label>Hotel</label>				
				 <?php $categoryDropDown = '<select class="form-control select2" name="hotel_id">
											  ...
											  $resCat = selectSql(TBL_HOTELS," where status='1'  ",' ORDER BY `id`');
											  if($db->num_rows2($resCat)){
											  	while($resultCat = $db->fetch_object2($resCat)){
													...
													$categoryDropDown .= '<option '.$selected.' value="'.$resultCat->id.'">'.ucfirst($resultCat->name).' - '.$resultCat->id_shop.'</option>';
												}
											  }
        ...
        <div class="col-xs-12">		     
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Hotel Mapping List</h3>
            </div>
