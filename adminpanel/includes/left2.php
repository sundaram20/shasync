  ...
  <section class="sidebar"> <!-- Sidebar user panel -->
    <div class="user-panel">
      ...
      <div class="pull-left info">
       ...
       $shortCode = selectColumn(TBL_SHOP,'short_code'," WHERE `id` = '".addslashes($_SESSION['shop'])."'"); 
       echo $shortCode; ?>
      </p>
      </div>
    </div>
 ...
 <!------------->
      ...
      <li class="treeview"> <a href="#"> <i class="fa fa-file-excel-o"></i> <span>Accounts</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
        <ul class="treeview-menu">
         ...
         <li class="treeview"> <a href="#"> <i class="fa fa-file-excel-o"></i> <span>Calls </span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
        <ul class="treeview-menu">
          <!-- sub menu-->
          <li><a href="<?php echo $SITE_URL; ?>/adminpanel/callmappings.php" rel="creditReport.php"><i class="fa fa-circle-o"></i>Mapping</a></li>
 ...
 <li><a href="<?php echo $SITE_URL; ?>/adminpanel/manageGrade.php" rel="editGrade.php"><i class="fa fa-circle-o"></i> Grade Master</a></li>
          ...
          <li class="treeview"><a href="#" rel=""><i class="fa fa-circle-o"></i><span>Hotel Master</span><span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span></a>
            <ul class="treeview-menu">
              ...
              <li><a href="<?php echo $SITE_URL; ?>/adminpanel/calendar.php" rel="calendar.php"><i class="fa fa-circle-o"></i>Hotel Calendar</a></li>
