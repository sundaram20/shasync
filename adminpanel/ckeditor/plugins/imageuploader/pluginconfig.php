...
$username = "admin"; $password = '46c17fb99b9c8c8ae8214834e1edf6b1';

    $useruploadfolder = "roomstatushub/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "roomstatushub/uploads";
        

    $useruploadfolder = "roomstatushub/uploaded_files/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "roomstatushub/uploaded_files/uploads";
    ...
    $useruploadfolder = "uploaded_files/uploads";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "uploaded_files/uploads";
